package Game;/*
Forbedringer:                                             Done?
Forminsk chat i Ship placement                            nope
Forstør chat i battlefield
Fjerne to ekstra ships placement når man har supmit
Skriv i Battlefield om man har ramt
Auto scroll både battlefield og ships placement
...
public class Battlefight extends JFrame implements ActionListener, Runnable {
    ...
    public static JButton quit, returnmenu, btnSend, connect;
    ...
    public Battlefight() {
        ...
        beskeder.setPreferredSize(new Dimension(100, 250));
